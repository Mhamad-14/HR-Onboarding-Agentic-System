...
* **Agent architecture:** Structured supervisor and specialist workers  
* **RAG/data:** Knowledge documents, embeddings, retrieval, and cited evidence  
* **LangGraph:** Workflow orchestration, persistence, memory, interrupts, and reliability  
* **Integration/quality:** Templates, SQLite, LangSmith, tests, and documentation  
- 
